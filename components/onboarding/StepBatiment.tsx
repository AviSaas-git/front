...
export function StepBatiment({
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (!user?.tenantId) {
      setErrors({
        nom: "Session expirée. Reconnectez-vous.",
      })
      return
    }
  ...
  return (
    <div className="bg-white/[0.03] border border-white/8 rounded-2xl p-7">
      ...
      <div
        className="flex items-center gap-2.5 bg-green-400/8
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-white/40 leading-relaxed">
          Un bâtiment = un poulailler ou une porcherie.
          Vous pourrez en ajouter d&apos;autres depuis
          les paramètres.
        </p>
      </div>
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-3">
          <FormField
            ...
            value={form.capacite || ""}
            onChange={(e) =>
              handleChange("capacite", e.target.value)
            }
          ...
          <FormField
            ...
            onChange={(e) =>
              handleChange("surfaceM2", e.target.value)
            }
          />
        </div>
